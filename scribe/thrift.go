...
type LogEntry struct {
  Client string `thrift:"1,required" json:"client"`
  Token string `thrift:"2,required" json:"token"`
  Loglevel string `thrift:"3,required" json:"loglevel"`
  Message  []string `thrift:"4,required" json:"message"`
}
